...
<div id="chatbot-wrapper" class="fixed inset-0 pointer-events-none z-[9999]">
    ...
    >
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-200 text-[11px] flex items-center gap-1.5 mt-0.5">
                            ...
                            <span id="chatbot-status-text"><?php echo e(__('Online Â· DLH Kota Palu')); ?></span>
                        </p>
                    </div>
                </div>
        ...
        <div class="shrink-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
            ...
            <p class="text-center text-[10px] text-slate-400 pb-2 select-none"><?php echo e(__('DLH Assistant Â· Kota Palu Â· Enter untuk kirim')); ?></p>
        </div>
    </div>
</div>
...
(function () {
    ...
    window.chatbotClear = function () {
        ...
        appendAIBubble(<?php echo \Illuminate\Support\Js::from(__('Chat telah dihapus. Ada yang bisa saya bantu? ðŸ™‚'))->toHtml() ?>);
        wire()?.call('clearChat');
    };
...
<?php /**PATH C:\xampp\htdocs\DLH - PALU\resources\views/livewire/chat-bot.blade.php ENDPATH**/ ?>