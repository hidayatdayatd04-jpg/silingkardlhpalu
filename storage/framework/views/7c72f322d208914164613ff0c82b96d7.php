...
<?php endif; ?>
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center pt-4">
                <a href="<?php echo e(url('/cek-pengaduan-rth')); ?>"
                            ...
                            initMap() {
                                ...
                                window.ensureMaplibreLoaded(function() {
                                    self.map = new maplibregl.Map({
                                        ...
                                        center: [<?php echo \Illuminate\Support\Js::from($longitude)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($latitude)->toHtml() ?>], zoom: 13, attributionControl: false
                                    });
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\DLH - PALU\storage\framework\views/livewire/views/522480a9.blade.php ENDPATH**/ ?>