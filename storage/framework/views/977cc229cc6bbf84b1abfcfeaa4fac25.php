...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.copy-ticket','data' => ['ticket' => $laporan->nomor_tiket,'class' => 'text-2xl font-bold font-mono mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['ticket' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($laporan->nomor_tiket),'class' => 'text-2xl font-bold font-mono mt-1']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.ticket-feedback','data' => ['ticket' => $laporan]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['ticket' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($laporan)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="space-y-4">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="font-semibold"><?php echo e($laporan->nama_pelapor); ?></span>
                        </div>
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Jenis Pengaduan')); ?></span>
                            <span class="font-semibold"><?php echo e($laporan->jenis_pengaduan); ?></span>
                        </div>
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Tanggal Lapor')); ?></span>
                            <span class="font-semibold"><?php echo e($laporan->created_at->format('d M Y H:i')); ?></span>
                        </div>
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Alamat')); ?></span>
                            <span class="font-semibold"><?php echo e($laporan->alamat); ?></span>
                        </div>
                    </div>
                    <div>
                        <span class="block text-sm text-slate-500 font-medium"><?php echo e(__('Deskripsi')); ?></span>
                        <p class="text-sm text-slate-700 dark:text-slate-300 mt-1"><?php echo e($laporan->deskripsi); ?></p>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($laporan->catatan_admin): ?>
                        <div class="p-4 bg-brand-50 dark:bg-brand-900/20 border border-brand-200 dark:border-brand-800 rounded-lg">
                            ...
                            <p class="text-sm mt-1"><?php echo e($laporan->catatan_admin); ?></p>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div wire:ignore <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'map-'.e($laporan->nomor_tiket).''; ?>wire:key="map-<?php echo e($laporan->nomor_tiket); ?>"
                         x-data x-init="setTimeout(function(){dlhSimpleMap('cek-map-<?php echo e($laporan->nomor_tiket); ?>',{lat:<?php echo \Illuminate\Support\Js::from($laporan->latitude)->toHtml() ?>,lng:<?php echo \Illuminate\Support\Js::from($laporan->longitude)->toHtml() ?>,zoom:14,popupText:'<?php echo e(__('Lokasi Pengaduan')); ?>'})},100)">
                        <div id="cek-map-<?php echo e($laporan->nomor_tiket); ?>" class="w-full h-[300px] border border-slate-200 dark:border-slate-800 rounded-md z-0"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($laporanList && $laporanList->isNotEmpty()): ?>
        <div class="max-w-4xl mx-auto space-y-4">
            <div class="bg-brand-50 dark:bg-brand-900/20 border border-brand-200 dark:border-brand-800 rounded-lg p-4">
                <p class="text-sm font-semibold text-brand-800 dark:text-brand-400">
                    <?php echo e(__('Ditemukan :count pengaduan dengan nomor HP tersebut', ['count' => $laporanList->count()])); ?>

                </p>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $laporanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm space-y-6">
                    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-4">
                        <div>
                            ...
                            <?php if (isset($component)) { $__componentOriginal0ba85dda8da2317d0ab5473991b5d00a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0ba85dda8da2317d0ab5473991b5d00a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.copy-ticket','data' => ['ticket' => $item->nomor_tiket,'class' => 'text-xl font-bold font-mono mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.copy-ticket'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['ticket' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->nomor_tiket),'class' => 'text-xl font-bold font-mono mt-1']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal99eaeb965d503948f5881d24e0efc523 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal99eaeb965d503948f5881d24e0efc523 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.ticket-feedback','data' => ['ticket' => $item]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.ticket-feedback'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['ticket' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal1a3ac395ac0a4ff13489a9dd135cb158 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1a3ac395ac0a4ff13489a9dd135cb158 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.status-timeline','data' => ['timeline' => \App\Services\TicketTimelineService::forTicket($item)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.status-timeline'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['timeline' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\App\Services\TicketTimelineService::forTicket($item))]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Nama Pelapor')); ?></span>
                            <span class="font-semibold"><?php echo e($item->nama_pelapor); ?></span>
                        </div>
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Jenis Pengaduan')); ?></span>
                            <span class="font-semibold"><?php echo e($item->jenis_pengaduan); ?></span>
                        </div>
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Tanggal Lapor')); ?></span>
                            <span class="font-semibold"><?php echo e($item->created_at->format('d M Y H:i')); ?></span>
                        </div>
                        <div>
                            <span class="block text-slate-500 font-medium"><?php echo e(__('Alamat')); ?></span>
                            <span class="font-semibold"><?php echo e($item->alamat); ?></span>
                        </div>
                    </div>

                    <div>
                        <span class="block text-sm text-slate-500 font-medium mb-1"><?php echo e(__('Deskripsi')); ?></span>
                        <p class="text-sm text-slate-700 dark:text-slate-300"><?php echo e($item->deskripsi); ?></p>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->catatan_admin): ?>
                        <div class="p-4 bg-brand-50 dark:bg-brand-900/20 border border-brand-200 dark:border-brand-800 rounded-lg">
                            <span class="block text-sm font-semibold text-brand-800 dark:text-brand-400"><?php echo e(__('Catatan Admin')); ?></span>
                            <p class="text-sm mt-1"><?php echo e($item->catatan_admin); ?></p>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->fotos->isNotEmpty()): ?>
                        <div>
                            <span class="block text-sm text-slate-500 font-medium mb-2"><?php echo e(__('Foto Bukti')); ?></span>
                            <div class="grid grid-cols-3 md:grid-cols-4 gap-2">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $item->fotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="aspect-square rounded-md overflow-hidden border border-slate-200 dark:border-slate-800">
                                    <img src="<?php echo e($foto->fullUrl()); ?>" alt="<?php echo e(__('Foto bukti pengaduan')); ?>" class="w-full h-full object-cover" />
                                    </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\DLH - PALU\storage\framework\views/livewire/views/245f7aba.blade.php ENDPATH**/ ?>