...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'size' => 20, 'stroke' => 2, 'filled' => null]));
...
foreach (array_filter((['name', 'size' => 20, 'stroke' => 2, 'filled' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($name === 'whatsapp'): ?>
    
    <?php if (isset($component)) { $__componentOriginal5e264ebbe3fc51715e8fc49106ff3a8b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5e264ebbe3fc51715e8fc49106ff3a8b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.social.whatsapp','data' => ['attributes' => $attributes->merge(['class' => 'inline-block shrink-0']),'style' => 'width:'.e($size).'px;height:'.e($size).'px']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icons.social.whatsapp'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->merge(['class' => 'inline-block shrink-0'])),'style' => 'width:'.e($size).'px;height:'.e($size).'px']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5e264ebbe3fc51715e8fc49106ff3a8b)): ?>
<?php $attributes = $__attributesOriginal5e264ebbe3fc51715e8fc49106ff3a8b; ?>
<?php unset($__attributesOriginal5e264ebbe3fc51715e8fc49106ff3a8b); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal5e264ebbe3fc51715e8fc49106ff3a8b)): ?>
<?php $component = $__componentOriginal5e264ebbe3fc51715e8fc49106ff3a8b; ?>
<?php unset($__componentOriginal5e264ebbe3fc51715e8fc49106ff3a8b); ?>
<?php endif; ?>
<?php else: ?>
    <svg 
        ...
        viewBox="0 0 24 24" 
        fill="<?php echo e($filled ? 'currentColor' : 'none'); ?>" 
        stroke="<?php echo e($filled ? 'none' : 'currentColor'); ?>" 
        stroke-width="<?php echo e($stroke); ?>" 
        stroke-linecap="round" 
        stroke-linejoin="round"
    >
        <?php echo $icons[$name] ?? $icons['alert-circle']; ?>

    </svg>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\DLH - PALU\resources\views/components/admin/icon.blade.php ENDPATH**/ ?>