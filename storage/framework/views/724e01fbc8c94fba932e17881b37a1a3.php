...
<div
    ...
    x-data="{
        open: false,
        search: '',
        selected: <?php echo \Illuminate\Support\Js::from((string) old($name, $selected))->toHtml() ?>,
        selectedLabel: '',
        ...
        selectOption(value, label) {
            ...
            this.$dispatch('select-lainnya', { name: '<?php echo e($name); ?>', value: value });
            this.$nextTick(() => {
                try { this.$wire && this.$wire.set('<?php echo e($name); ?>', value); } catch(e) {}
            });
        },
...
>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($label): ?>
        <label for="<?php echo e($id); ?>" class="fi-label">
            <?php echo e($label); ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($required): ?><span class="fi-required">*</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </label>
    ...
    <div class="fi-select-shell" :class="{ 'fi-select-shell--open': open }">
        ...
        <button
            ...
            class="fi-select-trigger <?php echo e($hasError ? 'fi-select-trigger--error' : ''); ?> <?php echo e($disabled ? 'fi-select-trigger--disabled' : ''); ?>"
        >
            <span x-show="!selected" class="fi-select-placeholder"><?php echo e($placeholder); ?></span>
    ...
    <?php elseif($hint): ?>
        <p class="fi-hint-sub"><?php echo e($hint); ?></p>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <style>
        ...
        .fi-select-option:hover { background: #f4faf6; }
        .fi-select-option--active { background: #178a53; color: #fff; font-weight: 500; }
        .fi-select-option--active:hover { background: #146a44; }
...
</div><?php /**PATH C:\xampp\htdocs\DLH - PALU\resources\views/components/admin/select.blade.php ENDPATH**/ ?>