...
<div x-data="{ open: false }" @click.away="open = false" @keydown.escape="open = false" class="relative">
    <button
        ...
        aria-label="<?php echo e(__('Bahasa')); ?>"
    ...
    >
        <span class="relative block h-7 w-7 rounded-full overflow-hidden ring-1 ring-black/5 shadow-inner">
            <img src="<?php echo e(asset('assets/images/' . ($current === 'en' ? 'english.png' : 'indonesia.png'))); ?>"
                 alt="" class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110" aria-hidden="true">
        </span>
        <span class="text-xs font-bold uppercase tracking-wide"><?php echo e($current === 'en' ? 'EN' : 'ID'); ?></span>
    ...
    >
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [['id','indonesia.png',__('Indonesia')],['en','english.png',__('Inggris')]]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$code,$flag,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <a href="<?php echo e(route('lang.switch', $code)); ?>"
           class="group/item flex items-center gap-3 px-2.5 py-2 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e($current === $code ? 'text-brand-700 dark:text-brand-300 bg-brand-50/70 dark:bg-brand-900/20' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/60'); ?>">
            <span class="block h-7 w-7 rounded-full overflow-hidden ring-1 ring-black/5 shadow-sm shrink-0">
                <img src="<?php echo e(asset('assets/images/' . $flag)); ?>" alt="" class="h-full w-full object-cover transition-transform duration-500 group-hover/item:scale-110" aria-hidden="true">
            </span>
            <span class="flex-1"><?php echo e($label); ?></span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($current === $code): ?>
...
<?php /**PATH D:\Backup\DLH - Palu\resources\views/components/public/language-switcher.blade.php ENDPATH**/ ?>