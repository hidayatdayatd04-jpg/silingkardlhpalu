...
<div class="flex items-center gap-2 text-sm">
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="group flex items-center gap-1.5 text-slate-500 transition-colors duration-200 hover:text-emerald-600 dark:text-slate-400 dark:hover:text-emerald-400">
...
<?php /**PATH D:\Backup\DLH - Palu\resources\views/components/admin/topbar/breadcrumb.blade.php ENDPATH**/ ?>