...
<?php
    $classes = 'rounded-lg border border-white/80 bg-white shadow-[0_12px_40px_rgba(15,23,42,0.06)]';
    if ($padding) {
        $classes .= ' p-4';
    }
    if ($hover) {
...
<?php /**PATH C:\xampp\htdocs\DLH - PALU\resources\views/components/admin/card.blade.php ENDPATH**/ ?>