...
<head>
    ...
    <meta property="og:image" content="<?php echo e(asset('assets/images/logo_kota_palu.png')); ?>">
    ...
    <meta property="twitter:image" content="<?php echo e(asset('assets/images/logo_kota_palu.png')); ?>">
            ...
            <div class="flex items-center shrink-0">
                <a href="/" class="group flex items-center gap-2.5 sm:gap-3">
                    <span class="relative inline-flex items-center justify-center shrink-0">
                        ...
                        <img src="<?php echo e(asset('assets/images/logo_kota_palu.png')); ?>" alt="Logo Kota Palu" class="relative h-9 sm:h-11 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
                    </span>
            ...
            <nav class="hidden lg:flex items-center gap-0.5 xl:gap-1 shrink-0">
                ...
                <div x-data="{ open: false }" @click.away="open = false" class="relative">
                    ...
                    <div x-show="open" 
                        ...
                        style="display: none;">
                        <a href="/profil#visi-misi" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap"><?php echo e(__('Visi & Misi DLH Kota Palu')); ?></a>
                ...
                <div x-data="{ open: false }" @click.away="open = false" class="relative">
                    <button @click="open = !open"
                        class="flex items-center gap-1 px-2.5 py-2 rounded-xl text-[13px] xl:text-sm font-semibold <?php echo e(request()->is('tata-penataan', 'cek-pengaduan-tata-penataan', 'peta-objek-pengawasan') ? 'text-brand-700 dark:text-brand-400 bg-brand-50 dark:bg-brand-900/20 ring-1 ring-brand-500/15' : 'text-slate-600 dark:text-slate-300 hover:text-brand-700 dark:hover:text-brand-400 hover:bg-brand-50/80 dark:hover:bg-slate-800/60'); ?> transition-colors focus:outline-none cursor-pointer select-none whitespace-nowrap">
                    ...
                    <div x-show="open"
                        ...
                        class="absolute left-0 mt-3 w-max min-w-[240px] rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl p-1.5 z-50 focus:outline-none"
                        style="display: none;">
                        <a href="/tata-penataan" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('tata-penataan') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Info Modul')); ?></a>
                        <a href="/peta-objek-pengawasan" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('peta-objek-pengawasan') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Peta Objek Pengawasan')); ?></a>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" @click.away="open = false" class="relative">
                    <button @click="open = !open"
                        class="flex items-center gap-1 px-2.5 py-2 rounded-xl text-[13px] xl:text-sm font-semibold <?php echo e(request()->is('peta-rth', 'cek-pengaduan-rth', 'perizinan-tebang-pohon', 'cek-perizinan-tebang-pohon', 'pinjam-taman', 'cek-pinjam-taman') ? 'text-brand-700 dark:text-brand-400 bg-brand-50 dark:bg-brand-900/20 ring-1 ring-brand-500/15' : 'text-slate-600 dark:text-slate-300 hover:text-brand-700 dark:hover:text-brand-400 hover:bg-brand-50/80 dark:hover:bg-slate-800/60'); ?> transition-colors focus:outline-none cursor-pointer select-none whitespace-nowrap">
                    ...
                    <div x-show="open" 
                        ...
                        class="absolute left-0 mt-3 w-max min-w-[240px] rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl p-1.5 z-50 focus:outline-none"
                        style="display: none;">
                        <a href="/peta-rth" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('peta-rth') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Peta RTH')); ?></a>
                        <a href="/perizinan-tebang-pohon" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('perizinan-tebang-pohon') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Izin Tebang Pohon')); ?></a>
                        <a href="/cek-perizinan-tebang-pohon" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('cek-perizinan-tebang-pohon') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Cek Izin Tebang')); ?></a>
                        <a href="/pinjam-taman" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('pinjam-taman') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Pinjam Pakai Taman')); ?></a>
                        <a href="/cek-pinjam-taman" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('cek-pinjam-taman') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Cek Pinjam Taman')); ?></a>
                    </div>
                </div>
                ...
                <div x-data="{ open: false, subOpen: false }" @click.away="open = false; subOpen = false" class="relative">
                    <button @click="open = !open"
                        class="flex items-center gap-1 px-2.5 py-2 rounded-xl text-[13px] xl:text-sm font-semibold <?php echo e(request()->is('lacak', 'berita*', 'survei', 'profil', 'pengaduan') ? 'text-brand-700 dark:text-brand-400 bg-brand-50 dark:bg-brand-900/20 ring-1 ring-brand-500/15' : 'text-slate-600 dark:text-slate-300 hover:text-brand-700 dark:hover:text-brand-400 hover:bg-brand-50/80 dark:hover:bg-slate-800/60'); ?> transition-colors focus:outline-none cursor-pointer select-none whitespace-nowrap">
                    ...
                    <div x-show="open"
                        ...
                        <a href="/survei" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('survei') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Survei Kepuasan (IKM)')); ?></a>
                        <a href="/profil" class="block px-4 py-2.5 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap <?php echo e(request()->is('profil') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : ''); ?>"><?php echo e(__('Tentang Kami')); ?></a>
                    </div>
                </div>
            </nav>

            <div class="flex items-center gap-2 shrink-0">
                <?php if (isset($component)) { $__componentOriginal79b29699943d37ca861f3e5480e41783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal79b29699943d37ca861f3e5480e41783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.language-switcher','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.language-switcher'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal79b29699943d37ca861f3e5480e41783)): ?>
<?php $attributes = $__attributesOriginal79b29699943d37ca861f3e5480e41783; ?>
<?php unset($__attributesOriginal79b29699943d37ca861f3e5480e41783); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal79b29699943d37ca861f3e5480e41783)): ?>
<?php $component = $__componentOriginal79b29699943d37ca861f3e5480e41783; ?>
<?php unset($__componentOriginal79b29699943d37ca861f3e5480e41783); ?>
<?php endif; ?>
            ...
            <div class="flex flex-col px-4 pt-2 pb-6 space-y-1.5">
                ...
                <div x-data="{ open: <?php echo e(request()->is('profil') ? 'true' : 'false'); ?> }">
                    ...
                    <div x-show="open" class="pl-4 space-y-1 mt-1" style="display: none;"
                         ...
                         x-transition:enter-start="opacity-0 -translate-y-1"
                         x-transition:enter-end="opacity-100 translate-y-0">
                        <a href="/profil#visi-misi" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Visi & Misi DLH Kota Palu')); ?></a>
                ...
                <div x-data="{ open: <?php echo e(request()->is('tata-penataan', 'peta-objek-pengawasan') ? 'true' : 'false'); ?> }">
                    <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2 rounded-lg text-base font-semibold <?php echo e(request()->is('tata-penataan', 'peta-objek-pengawasan') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800'); ?> focus:outline-none cursor-pointer">
                        <span><?php echo e(__('Bidang Tata Penataan')); ?></span>
                        <svg class="h-4 w-4 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="open" class="pl-4 space-y-1 mt-1" style="display: none;"
                         ...
                         x-transition:enter-start="opacity-0 -translate-y-1"
                         x-transition:enter-end="opacity-100 translate-y-0">
                        <a href="/tata-penataan" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Info Modul')); ?></a>
                        <a href="/peta-objek-pengawasan" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Peta Objek Pengawasan')); ?></a>
                    </div>
                </div>

                <!-- Bidang RTH (Dropdown Mobile) -->
                <div x-data="{ open: <?php echo e(request()->is('peta-rth', 'perizinan-tebang-pohon', 'cek-perizinan-tebang-pohon', 'pinjam-taman', 'cek-pinjam-taman') ? 'true' : 'false'); ?> }">
                    <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2 rounded-lg text-base font-semibold <?php echo e(request()->is('peta-rth', 'perizinan-tebang-pohon', 'cek-perizinan-tebang-pohon', 'pinjam-taman', 'cek-pinjam-taman') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800'); ?> focus:outline-none cursor-pointer">
                        <span><?php echo e(__('Bidang RTH')); ?></span>
                        <svg class="h-4 w-4 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div x-show="open" class="pl-4 space-y-1 mt-1" style="display: none;"
                         ...
                         x-transition:enter-start="opacity-0 -translate-y-1"
                         x-transition:enter-end="opacity-100 translate-y-0">
                        <a href="/peta-rth" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Peta RTH')); ?></a>
                        <a href="/perizinan-tebang-pohon" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Izin Tebang Pohon')); ?></a>
                        <a href="/cek-perizinan-tebang-pohon" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Cek Izin Tebang')); ?></a>
                        <a href="/pinjam-taman" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Pinjam Taman')); ?></a>
                        <a href="/cek-pinjam-taman" class="block px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800"><?php echo e(__('Cek Pinjam Taman')); ?></a>
                    </div>
                </div>

                <!-- UPTD (Dropdown Mobile) -->
                <div x-data="{ open: <?php echo e(request()->is('uptd*') ? 'true' : 'false'); ?> }">
                ...
                <div x-data="{ open: <?php echo e(request()->is('lacak', 'berita*', 'survei', 'profil', 'pengaduan') ? 'true' : 'false'); ?>, subOpen: false }">
                    <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2 rounded-lg text-base font-semibold <?php echo e(request()->is('lacak', 'berita*', 'survei', 'profil', 'pengaduan') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/50 dark:bg-brand-900/10' : 'text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800'); ?> focus:outline-none cursor-pointer">
                        <span><?php echo e(__('Informasi')); ?></span>
                        <svg class="h-4 w-4 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div x-show="open" class="pl-4 space-y-1 mt-1" style="display: none;"
                        ...
                        <a href="/survei" class="block px-3 py-2 rounded-lg text-sm font-medium <?php echo e(request()->is('survei') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/30 dark:bg-brand-900/10' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'); ?>"><?php echo e(__('Survei Kepuasan')); ?></a>
                        <a href="/profil" class="block px-3 py-2 rounded-lg text-sm font-medium <?php echo e(request()->is('profil') ? 'text-brand-600 dark:text-brand-400 bg-brand-50/30 dark:bg-brand-900/10' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'); ?>"><?php echo e(__('Tentang Kami')); ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-8 lg:gap-6 pb-10 border-b border-slate-200 dark:border-slate-800">
                ...
                <div class="col-span-2 md:col-span-4 lg:col-span-4 space-y-4">
                    <div class="flex items-center gap-3">
                        <img src="<?php echo e(asset('assets/images/logo_kota_palu.png')); ?>" alt="Logo Kota Palu" class="h-12 w-auto object-contain drop-shadow-sm">
                        <div>
                ...
                <div class="col-span-1 lg:col-span-2 space-y-3">
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="/pengaduan" class="inline-flex items-center gap-1.5 text-slate-600 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:translate-x-0.5 transition-all duration-200"><?php echo e(__('Pengaduan')); ?></a></li>
                ...
                <div class="col-span-1 lg:col-span-2 space-y-3">
                    ...
                    <ul class="space-y-2.5 text-sm">
                        <li><a href="/peta-rth" class="inline-flex items-center gap-1.5 text-slate-600 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:translate-x-0.5 transition-all duration-200"><?php echo e(__('Peta RTH')); ?></a></li>
                        ...
                        <li><a href="/perizinan-tebang-pohon" class="inline-flex items-center gap-1.5 text-slate-600 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:translate-x-0.5 transition-all duration-200"><?php echo e(__('Izin Tebang')); ?></a></li>
                        <li><a href="/pinjam-taman" class="inline-flex items-center gap-1.5 text-slate-600 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:translate-x-0.5 transition-all duration-200"><?php echo e(__('Pinjam Taman')); ?></a></li>
                    </ul>
                </div>
            ...
            <div class="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="/survei" class="hover:text-brand-600 dark:hover:text-brand-400 transition-colors"><?php echo e(__('Survei IKM')); ?></a>
                </div>
            </div>
        </div>
    </footer>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2521113731-0', $__key);
...
</html><?php /**PATH D:\Backup\DLH - Palu\resources\views/layouts/app.blade.php ENDPATH**/ ?>