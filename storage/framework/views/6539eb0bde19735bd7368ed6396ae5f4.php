...
<div id="dlh-preloader" role="status" aria-live="polite" aria-label="<?php echo e(__('Memuat portal DLH Kota Palu')); ?>">
    ...
    <div class="dlh-pre__inner">
        <div class="dlh-pre__badge">
            ...
            <img src="<?php echo e(asset('assets/images/logo_kota_palu.png')); ?>" alt="" width="92" height="92" class="dlh-pre__logo">
        </div>
        <p class="dlh-pre__title"><?php echo e(__('Dinas Lingkungan Hidup')); ?></p>
        <p class="dlh-pre__subtitle"><?php echo e(__('Kota Palu')); ?></p>
        <div class="dlh-pre__bar" aria-hidden="true"><span id="dlh-pre-fill"></span></div>
        <p class="dlh-pre__hint"><?php echo e(__('Menyiapkan layanan untuk Anda…')); ?></p>
    </div>
</div>
...
<?php /**PATH D:\Backup\DLH - Palu\resources\views/components/public/preloader.blade.php ENDPATH**/ ?>