...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'size' => 20, 'stroke' => 2]));
...
foreach (array_filter((['name', 'size' => 20, 'stroke' => 2]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH D:\Backup\DLH - Palu\resources\views/components/admin/icon.blade.php ENDPATH**/ ?>