...
return new class extends Migration
{
     ...
     * (orphan) pada data_tanam_pohons.
     */
    public function up(): void
    {
        Schema::dropIfExists('perizinan_tebang_pohons');

        if (Schema::hasTable('data_tanam_pohons') && Schema::hasColumn('data_tanam_pohons', 'perizinan_tebang_pohon_id')) {
            Schema::table('data_tanam_pohons', function (Blueprint $table) {
