    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto">
        ...
        <div class="ck-card">
            <div class="ck-card-head">
                ...
                <div>
                    <h3 class="ck-card-title">{{ __('Cek via Nomor Pengajuan') }}</h3>
                    <p class="ck-card-desc">{{ __('Masukkan nomor pengajuan RINTEK/PERTEK yang Anda terima.') }}</p>
                </div>
            </div>
        ...
        <div class="ck-card">
            <div class="ck-card-head">
                ...
                <div>
                    ...
                    <p class="ck-card-desc">{{ __('Cari pengajuan berdasarkan nama perusahaan.') }}</p>
                </div>
            </div>
