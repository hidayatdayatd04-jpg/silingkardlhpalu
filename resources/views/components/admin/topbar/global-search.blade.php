<div class="hidden lg:block" x-data="{ focused: false }">
    <div class="relative search-glow" :class="focused ? 'z-10' : ''">
        ...
        <input
            ...
            class="h-10 w-[340px] cursor-pointer rounded-full border border-slate-200/80 bg-slate-50/60 py-2 pl-4 pr-20 text-[13px] text-slate-700 transition-[background-color,border-color,box-shadow] duration-200 placeholder:text-slate-400 hover:border-slate-300 hover:bg-white focus-visible:outline-none dark:border-white/[.08] dark:bg-white/[.04] dark:text-slate-200 dark:placeholder:text-slate-500 dark:hover:border-white/[.15] dark:hover:bg-white/[.06]"
        />
