...
<div class="flex items-center gap-2 text-sm">
    <a href="{{ route('admin.dashboard') }}" aria-label="Dashboard" class="group flex items-center gap-1.5 text-slate-500 transition-colors duration-200 hover:text-emerald-600 dark:text-slate-400 dark:hover:text-emerald-400">
