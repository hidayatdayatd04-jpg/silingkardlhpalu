...
@section('title', 'UPTD Lab Lingkungan - Dinas Lingkungan Hidup Kota Palu')
@section('description', 'UPTD Laboratorium Lingkungan Dinas Lingkungan Hidup Kota Palu.')
...
<div class="reveal is-revealed flex flex-col items-center justify-center min-h-[62vh] text-center px-4">
    ...
    <h1 class="text-3xl font-bold text-slate-900 dark:text-white sm:text-4xl tracking-tight">UPTD Lab Lingkungan</h1>
