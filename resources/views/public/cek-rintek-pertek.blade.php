...
<div class="public-service-page max-w-4xl mx-auto space-y-6 md:space-y-8">
    <x-public.page-hero badge="{{ __('Sampah & LB3') }}" title="{{ __('Cek Status RINTEK/PERTEK') }}" description="{{ __('Masukkan nomor pengajuan atau email untuk melihat status pengajuan.') }}" icon="search" />
