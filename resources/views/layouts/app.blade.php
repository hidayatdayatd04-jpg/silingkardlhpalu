    ...
    <header x-data="{ mobileMenuOpen: false }"
                    ...
                    <div x-show="open"
                        ...
                        <div class="relative">
                            ...
                            <div x-show="persampahanOpen"
                                ...
                                <!-- Peta Persampahan Submenu -->
                                <div class="relative">
                                    <button type="button" @click="petaOpen = !petaOpen" class="w-full flex items-center justify-between px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-xl font-medium transition-colors whitespace-nowrap cursor-pointer focus:outline-none {{ request()->is('jalur-angkut*', 'tpa*', 'peta-persampahan*') ? 'text-brand-600 dark:text-brand-400' : '' }}">
                                        <span>{{ __('Peta Persampahan') }}</span>
                                        <x-icons.ui name="chevron-right" class="ml-2 h-3.5 w-3.5 transition-transform duration-200" x-bind:class="{ 'rotate-90': petaOpen }" />
                                    </button>
                                    <div x-show="petaOpen"
                                        x-transition:enter="transition ease-out duration-150"
                                        x-transition:enter-start="opacity-0 -translate-x-1"
                                        ...
                                        class="pl-4 space-y-1 mt-1"
                                        style="display: none;">
                                        <a href="/jalur-angkut" class="block px-3 py-1.5 text-xs text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-lg transition-colors whitespace-nowrap {{ request()->is('jalur-angkut', 'peta-persampahan') ? 'text-brand-600 dark:text-brand-400 font-semibold' : '' }}">{{ __('Jalur Angkut') }}</a>
                                        <a href="/tpa" class="block px-3 py-1.5 text-xs text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/40 hover:text-brand-600 dark:hover:text-brand-400 rounded-lg transition-colors whitespace-nowrap {{ request()->is('tpa') ? 'text-brand-600 dark:text-brand-400 font-semibold' : '' }}">{{ __('TPA') }}</a>
                                    </div>
                                </div>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="flex flex-col px-4 pt-2 pb-6 space-y-1.5">
                    ...
                    <div x-show="open" class="pl-4 space-y-1 mt-1" style="display: none;"
                        ...
                        <div>
                            <div class="flex items-center justify-between rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800">
                                ...
                                <button type="button" @click="labOpen = !labOpen" class="px-2 py-2 text-slate-400 hover:text-brand-600 focus:outline-none cursor-pointer">
                                    <x-icons.ui name="chevron-down" class="h-3.5 w-3.5 transition-transform duration-200" x-bind:class="{ 'rotate-180': labOpen }" />
                                </button>
                            </div>
                            <div x-show="labOpen" class="pl-3 space-y-1 mt-1">
                                <a href="/uptd/jurnal-lab" class="block px-3 py-1.5 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">Jurnal Lab</a>
                            </div>
                        </div>
                        <div>
                            <div class="flex items-center justify-between rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800">
                                ...
                                <button type="button" @click="tpaOpen = !tpaOpen" class="px-2 py-2 text-slate-400 hover:text-brand-600 focus:outline-none cursor-pointer">
                                    <x-icons.ui name="chevron-down" class="h-3.5 w-3.5 transition-transform duration-200" x-bind:class="{ 'rotate-180': tpaOpen }" />
                                </button>
                            </div>
                            <div x-show="tpaOpen" class="pl-3 space-y-1 mt-1">
                                <a href="/uptd/tpa-kawatuna/sejarah" class="block px-3 py-1.5 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800">Sejarah</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ request()->is('lacak', 'berita*', 'tentang', 'pengaduan') ? 'true' : 'false' }}, infoOpen: {{ request()->is('lacak', 'berita*', 'tentang') ? 'true' : 'false' }} }">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-[1.4fr_repeat(5,minmax(0,1fr))] items-start gap-8 lg:gap-6 pb-10 border-b border-slate-200 dark:border-slate-800">
                ...
                <div class="col-span-1 lg:col-span-1 min-w-0 space-y-3">
                    ...
                    <ul class="space-y-2.5 text-sm">
                        ...
                        <li><a href="/monitoring-armada" class="inline-flex items-center gap-1.5 text-slate-600 dark:text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:translate-x-0.5 transition-[color,transform] duration-200">{{ __('Monitoring Armada') }}</a></li>
